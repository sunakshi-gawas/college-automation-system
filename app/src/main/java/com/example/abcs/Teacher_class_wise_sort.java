...
public class Teacher_class_wise_sort extends AppCompatActivity {
    Button _1,_2,_3,_4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_class_wise_sort);
...
//        mech.setText(getIntent().getStringExtra("deptmech"));
        ...
        _1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Teacher_class_wise_sort.this,Teacher_asper_dept_class.class);
                ...
                if(techdept.getText().toString().equals("Comp")){
                    ...
                    Toast.makeText(Teacher_class_wise_sort.this, "Hello Mam", Toast.LENGTH_SHORT).show();
