...
public class Admin_sort_studentdata_deptwise extends AppCompatActivity {
    Button comp, it,entc,cvil,mech;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_sort_studentdata_deptwise);
        ...
        comp .setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Admin_sort_studentdata_deptwise.this,Admin_class_wise_sort.class);
