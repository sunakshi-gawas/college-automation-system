...
public class Teacher_Doc_wise_sort extends AppCompatActivity {
    Button _1, _2, _3, _4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_doc_wise_sort);
...
//        mech.setText(getIntent().getStringExtra("deptmech"));
        ...
        _1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Teacher_Doc_wise_sort.this,Teacher_required_download.class);
