...
public class Teacher_asper_dept_class extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_teacher_asper_dept_class);
        ...
        recview=(RecyclerView)findViewById(R.id.recpp);
        recview.setLayoutManager(new LinearLayoutManager(this));
        datalist=new ArrayList<StudentData>();
        adapter=new TeacherAdpt(datalist);
...
//it
        ...
        db.collection("demo").whereEqualTo("_Class",txt_yr).whereEqualTo("Branch",txt_dept).get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        {
                            StudentData obj=d.toObject(StudentData.class);
                            datalist.add(obj);
                        }
