...
public class TeacherDataAdpt extends RecyclerView.Adapter<TeacherDataAdpt.myviewholder> {
    ArrayList<TeacherData> datalist;
    FirebaseFirestore fstore;



    public TeacherDataAdpt(ArrayList<TeacherData> datalist) {
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.teacherdata_singlerow, parent, false);
    ...
    public void onBindViewHolder(@NonNull myviewholder holder, int position) {
        ...
        holder.tvv2.setText(datalist.get(position).getEmpolyee_No());
        holder.tvv3.setText(datalist.get(position).getEmail());
        ...
        public myviewholder(@NonNull View itemView) {
            ...
            delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //delete user
                    fstore.collection("tdemo").document(tvv3.getText().toString())
                            .delete()
