...
public class Admin_teachers_reg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tdesg=findViewById(R.id.te_desg);
        tbr=findViewById(R.id.te_br);
        ...
        tdob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(Admin_teachers_reg.this,
        ...
        treg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ve.put("DOB",t_dob);
                ve.put("Gender",t_gen);
                ve.put("Department",t_br);
                ve.put("Designation",t_desg);
                ...
                treference.set(ve).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Admin_teachers_reg.this, "Error"+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
