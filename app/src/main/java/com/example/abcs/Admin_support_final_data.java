...
public class Admin_support_final_data {
    Admin_support_final_data(){
    ...
    public Admin_support_final_data(String email, String name, String section, String _class, String branch, String installment, String mobile_no, String paidamount, String paymentid, String secrem, String thirdinstrem, String fourthrem) {
        Email = email;
        Name = name;
        Section = section;
        this._class = _class;
