...
public class doc_up_12 extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            Toast.makeText(doc_up_12.this, imageuri.toString(), Toast.LENGTH_SHORT).show();
            ...
            //--->patha
            final StorageReference filepath = storageReference.child("final student data/"+ "/"+auth.getCurrentUser().getUid()+"/12" + ".pdf");
            Toast.makeText(doc_up_12.this, filepath.getName(), Toast.LENGTH_SHORT).show();
...
//                        startActivity(intent);
                        ...
                        // dialog.dismiss();
                        Toast.makeText(doc_up_12.this, "UploadedFailed", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
