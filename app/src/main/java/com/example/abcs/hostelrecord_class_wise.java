...
public class hostelrecord_class_wise extends AppCompatActivity {
    Button _1,_2,_3,_4;
    TextView comp, it,entc,cvil,mech;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hostelrecord_class_wise);
        ...
        _1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(hostelrecord_class_wise.this,Admin_hostel_payrecord.class);
