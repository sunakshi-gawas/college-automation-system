...
public class AccountAdpt extends RecyclerView.Adapter<AccountAdpt.myviewholder> {
    ArrayList<AccountData> datalist;
    FirebaseFirestore fstore;



    public AccountAdpt(ArrayList<AccountData> datalist) {
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.accountdata_singlerow, parent, false);
        ...
        public myviewholder(@NonNull View itemView) {
            ...
            delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //delete user
                    fstore.collection("Ademo").document(tvv3.getText().toString())
                            .delete()
